...
class Suggest : Command("suggest", null, 300) {
    override fun onInvoke(event: GuildMessageReceivedEvent, arguments: List<String>, flags: List<Flag>, register: ArdentRegister) {
        if (arguments.size < 10) {
            register.sender.cmdSend("Please send a suggestion to the Ardent team! *10 words minimum*", this, event)
            ...
            register.sender.cmdSend("Suggestion sent! Join our server to get updates and hang out @ https://discord.gg/Dtg23A7",
                    this, event)
        }
    }
}